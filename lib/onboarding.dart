...
import 'package:backendintegration/Components/color.dart';
import 'package:backendintegration/Components/onboarding_data.dart';
import 'package:backendintegration/floralfiesta.dart';
    ...
    return Container(
      ...
      // ),
       ...
       if (currentIndex == controller.items.length - 1) {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Floralfiesta()),
          );
        } else {
          setState(() {
            currentIndex++; // Move to the next onboarding page
          });
        }
      },
      child: Text(currentIndex == controller.items.length - 1 ? "Get started" : "Continue",
